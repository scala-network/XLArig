...
xlarig::FileLog::FileLog(const char *fileName)
{
    uv_fs_t req;
...
void xlarig::FileLog::print(int, const char *line, size_t, size_t size, bool colors)
{
    if (m_file < 0 || colors) {
        return;
    }
...
void xlarig::FileLog::onWrite(uv_fs_t *req)
{
