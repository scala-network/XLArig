...
#ifdef _MSC_VER
#   define VARIANT2_SET_ROUNDING_MODE() if (BASE == xlarig::VARIANT_2) { _control87(RC_DOWN, MCW_RC); }
#else
#   define VARIANT2_SET_ROUNDING_MODE() if (BASE == xlarig::VARIANT_2) { fesetround(FE_DOWNWARD); }
#endif
