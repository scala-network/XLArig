...
template void cn_gpu_inner_arm<xlarig::CnAlgo<xlarig::Algorithm::CN_GPU>().iterations(), xlarig::CnAlgo<xlarig::Algorithm::CN_GPU>().mask()>(const uint8_t* spad, uint8_t* lpad);
