...
xlarig::Assembly xlarig::Asm::parse(const char *assembly, Assembly defaultValue)
{
...
xlarig::Assembly xlarig::Asm::parse(const rapidjson::Value &value, Assembly defaultValue)
{
    if (value.IsBool()) {
...
const char *xlarig::Asm::toString(Assembly assembly)
{
    return asmNames[assembly];
}


rapidjson::Value xlarig::Asm::toJSON(Assembly assembly)
{
