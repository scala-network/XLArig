...
xlarig::ApiRouter::ApiRouter(Base *base) :
    m_base(base)
{
}


xlarig::ApiRouter::~ApiRouter()
{
}


void xlarig::ApiRouter::onRequest(IApiRequest &request)
{
...
void xlarig::ApiRouter::getHashrate(rapidjson::Value &reply, rapidjson::Document &doc) const
{
    using namespace rapidjson;
...
void xlarig::ApiRouter::getMiner(rapidjson::Value &reply, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
...
void xlarig::ApiRouter::getThreads(rapidjson::Value &reply, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
    const Hashrate *hr = Workers::hashrate();
